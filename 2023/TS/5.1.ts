...
const result = almanac.seeds.map(x => mapping(mapping(mapping(mapping(mapping(mapping(mapping(x, almanac.seedToSoil), almanac.soilToFertilizer), almanac.fertilizerTowater), almanac.waterToLight), almanac.lightToTemperature), almanac.temperatureToHumidity), almanac.humidityToLocation));
